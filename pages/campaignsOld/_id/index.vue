<template lang="pug">
  div
    ...
    faction-sheet(v-model="form.rebels" :campaign="form" faction="rebels" img="/rebels.webp" )
      
    faction-sheet(v-model="form.empire" :campaign="form" faction="empire" img="/empire.webp" )
